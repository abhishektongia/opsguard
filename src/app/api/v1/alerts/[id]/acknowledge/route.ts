...
import { broadcastAlertAcknowledged } from '@/lib/socket';
...
export async function POST(
  ...
  try {
    ...
    // Broadcast alert:acknowledged event to all connected users in the organization
    broadcastAlertAcknowledged(orgId, alert.id, user?.id || 'system');
